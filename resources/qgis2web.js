...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [14566257.788872, 4007639.146880, 23304341.507580, 8501510.773645], maxZoom: 10, minZoom: 1, projection: new ol.proj.Projection({
            code: 'USER:100000',
            extent: [-20037508.342789, -20037508.342789, 21806263.960000, 20037508.342789],
            units: 'm'})
    })
});
...
map.getView().fit([14566257.788872, 4007639.146880, 23304341.507580, 8501510.773645], map.getSize());
